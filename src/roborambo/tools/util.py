...
# Decorators
def tool_desc(*args, **kwargs): 
    return wrap_config(args, **storeifindictlist({'tool_desc': {'desc': str}}, desc = args[0]))

def tool_name(*args, **kwargs): 
    return wrap_config(args, **storeifindictlist({'tool_name': {'name': str}}, name = args[0]))
